...
max_list = copy.deepcopy(original_list)  # Копирование списка в список макс. путей
min_list = copy.deepcopy(original_list)  # Копирование списка в список мин. путей
for i in range(1, 20):
...
for i in range(1, 20):
    for j in range(1, 20):
        ...
        if (i > 2 and i < 15 and j == 6):
            ...
            min_list[i][j] = original_list[i][j] + min(min_list[i][j - 1], min_list[i - 1][j])
